                        ...
                        @foreach($orders as $key=> $order)
                            ...
                            @if($cancel->count()< 1)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($order->status == 0)
                                            <a href="{{ route('order_status',$order->id) }}" class="btn btn-sm btn-warning">Pending</a>

                                            @elseif ($order->status == 1)
                                                <a href="{{ route('order_status',$order->id) }}" class="btn btn-sm btn-primary">Packaging</a>
                                            @elseif ($order->status == 2)
                                                <a href="{{ route('order_status',$order->id) }}" class="btn btn-sm btn-info">Shipping</a>
                                            @else
