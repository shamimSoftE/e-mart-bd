    ...
    <div id="flStackForm" class="col-lg-12 layout-spacing layout-top-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <div class="offset-1 col-xl-10 col-md-10 col-sm-10 col-10">
                <form action="{{ route('about_update',$about) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group mb-3">
                                <label for="name">Our Mission <sup style="color:red">*</sup></label>
                                <textarea name="mission" class="form-control" cols="3">{{ $about->mission }}</textarea>
                            </div>
                            @error('mission')
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="vission" class="form-control" cols="3">{{ $about->vission }}</textarea>
                            </div>
                            @error('vission')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea id="editor" name="our_store" class="form-control" rows="6">{{ $about->our_store }}</textarea>
                            </div>
                            @error('our_store')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12">
                            <div class="form-group mb-3">
                                <label for="name">About Page Image Preview</label><br/>
                                <img src="{{ asset("Back/images/about/".$about->image) }}" style="height:150px" alt="About-Page-Img">
                            </div>
                        </div>
