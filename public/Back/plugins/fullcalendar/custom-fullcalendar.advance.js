$(document).ready(function() {
    ...
    function setCurrentDateHighlightStyle() {
        getCurrentDate = $('.fc-section-skeleton .fc-today').attr('data-date');
        if (getCurrentDate === undefined) {
            return;
        }
        splitDate = getCurrentDate.split('-');
        if (splitDate[2] < 10) {
            $('.fc-section-skeleton .fc-today .fc-day-number').css('padding', '3px 8px');
        } else if (splitDate[2] >= 10) {
            $('.fc-section-skeleton .fc-today .fc-day-number').css('padding', '3px 4px');
        }
    }
