$(document).ready(function() {
	...
	*/
	...
	$('.close-message').on('click', function(event) {
		...
		$('.section-box .collapse').collapse('hide')
		$(this).parents('.section-box').css({
			width: '0',
			left: 'auto',
			right: '-46px'
		});
	...
	/*
		fn. contentBoxPosition ==> Triggered when clicked on any each mail to show the mail section.
	*/
	function contentBoxPosition() {
		$('.section-box .collapse').on('show.bs.collapse', function(event) {
			var getCollpaseElementId = this.id;
			var getSelectedMailTitleElement = $('.section-box').find('.mail-title');
			var getSelectedMailContentTitle = $(this).find('.mail-section').attr('data-mailTitle');
			$(this).parent('.section-box').css({
				width: '100%',
				left: '0',
				right: '100%'
			});
	...
	*/
	var $listbtns = $('.list-actions').click(function() {
		$(this).parents('.mail-box-container').find('.mailbox-inbox > .section-box').css({
			width: '0',
			left: 'auto',
			right: '-46px'
		});
	...
	function $_sendMail(getDraftTragetID) {
		$("#btn-send").off('click').on('click', function(event) {
                                        ...
                                        '<div class="d-flex">' +
                                            ...
                                            '<div class="f-body" data-mailFrom="'+$_mailFrom+'" data-mailTo="'+$_mailTo+'" data-mailCC="'+$_mailCC+'" >' +
                                                ...
                                                '<div class="meta-title-tag">' +
                                                    '<p class="mail-section-excerpt" data-mailDescription="'+$_mailDescriptionText+'">'+attachmentIcon+'<span class="mail-title" data-mailTitle="'+$_mailSubject+'">'+$_mailSubject+' - </span>'+$_mailDescriptionText+'</p>' +
                                                    '<div class="tags">' +
			...
			$html2 = '<div id="'+randomAlphaNumeric+'" class="collapse" aria-labelledby="'+randomAlphaNumeric+'" data-parent="#mailbox-inbox">'+
		                '<div class="mail-section-container sentmail" data-mailFrom="'+$_mailFrom+'" data-mailTo="'+$_mailTo+'" data-mailCC="'+$_mailCC+'" >'+
		                    '<div class="d-flex justify-section-between mb-3">'+
		                    	'<div class="d-flex user-info">'+
	                                '<div class="f-body">'+
	                                    '<div class="meta-mail-time">'+
                                            ...
                                            '</div>'+
	                                        '<p class="mail-section-meta-date">'+today+' -</p>'+
	                                        '<p class="meta-time align-self-center">'+formatAMPM(new Date)+'</p>'+
	                                    '</div>'+
	                               '</div>'+
	                            '</div>'+
		                    ...
		                    "<p class='mail-section' data-mailTitle='"+$_mailSubject+"' data-mailDescription='"+$_textDelta+"'>"+$_mailDescriptionInnerHTML+"</p>"+
		    ...
		    $("#ct").prepend($html);
		    $(".section-box > .msg-close").after($html2);
                                    ...
                                    '<div class="mail-item-inner">' +
                                        ...
                                        '<div class="d-flex">' +
                                            ...
                                            '<div class="f-body" data-mailFrom="'+$_mailFrom+'" data-mailTo="'+$_mailTo+'" data-mailCC="'+$_mailCC+'" >' +
                                                ...
                                                '</div>' +
                                                '<div class="meta-title-tag">' +
                                                    "<p class='mail-section-excerpt' data-mailDescription='"+$_textDelta+"'><span class='mail-title' data-mailTitle='"+$_mailSubject+"'>Draft: "+$_mailSubject+" - </span>"+$_mailDescription+"</p>" +
                                                    '<div class="tags">' +
                                                        '<span class="g-dot-primary"></span>' +
                                                        '<span class="g-dot-warning"></span>' +
                                                        '<span class="g-dot-success"></span>' +
	...
	$("#btn-reply").on('click', function(event) {
                        ...
                        '<div class="mail-item-inner">' +
                            ...
                            '<div class="d-flex">' +
                                ...
                                '<div class="f-body" data-mailFrom="'+$_mailFrom+'" data-mailTo="'+$_mailTo+'" data-mailCC="'+$_mailCC+'" >' +
                                    ...
                                    '</div>' +
                                    '<div class="meta-title-tag">' +
                                        '<p class="mail-section-excerpt" data-mailDescription="'+$_mailDescriptionText+'"><span class="mail-title" data-mailTitle="'+$_mailSubject+'">'+$_mailSubject+' - </span>'+$_mailDescriptionText+'</p>' +
                                        '<div class="tags">' +
                                            '<span class="g-dot-primary"></span>' +
                                            '<span class="g-dot-warning"></span>' +
                                            '<span class="g-dot-success"></span>' +
		...
		$html2 = '<div id="'+randomAlphaNumeric+'" class="collapse" aria-labelledby="sdfsdaf" data-parent="#mailbox-inbox">'+
	                '<div class="mail-section-container sentmail" data-mailFrom="'+$_mailFrom+'" data-mailTo="'+$_mailTo+'" data-mailCC="'+$_mailCC+'" >'+
	                    ...
	                    '<div class="d-flex justify-section-between mb-5">'+
		                    '<div class="d-flex user-info">'+
                                '<div class="f-body">'+
                                    '<div class="meta-mail-time">'+
                                    '<div class="">'+
	...
	*/
	function $_GET_mailItem_Draft() {
		$(".mail-item.draft").off('click').on('click', function(event) {
		    ...
		    var $_mailDescription =  JSON.parse($(this).find('.mail-section-excerpt').attr('data-maildescription'));
	...
	*/
	function $_GET_mailItem_Reply() {
		$(".reply").on('click', function(event) {
			...
			var $_mailFrom =  $(this).parents('.mail-section-container').attr('data-mailFrom');
		    var $_mailTo =  $(this).parents('.mail-section-container').attr('data-mailTo');
		    var $_mailCC =  $(this).parents('.mail-section-container').attr('data-mailCC');
			var $_mailSubject = $(this).parents('.mail-section-container').find('.mail-section').attr('data-mailtitle');
		    var $_mailDescription =  JSON.parse($(this).parents('.mail-section-container').find('.mail-section').attr('data-maildescription'));
