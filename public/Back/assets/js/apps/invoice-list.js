var invoiceList = $('#invoice-list').DataTable({
    "dom": "<'inv-list-top-category'<'row'<'col-sm-12 col-md-6 d-flex justify-section-md-start justify-section-center'l<'dt-action-buttons align-self-center'B>><'col-sm-12 col-md-6 d-flex justify-section-md-end justify-section-center mt-md-0 mt-3'f<'toolbar align-self-center'>>>>" +
        "<'table-responsive'tr>" +
        "<'inv-list-bottom-category d-sm-flex justify-section-sm-between text-center'<'inv-list-pages-count  mb-sm-0 mb-3'i><'inv-list-pagination'p>>",
