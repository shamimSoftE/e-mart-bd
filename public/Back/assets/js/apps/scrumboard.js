    ...
    */
    ...
    function $_taskSortable() {
        $('[data-sortable="true"]').sortable({
            connectWith: '.connect-sorting-section',
            items: ".card",
            cursor: 'move',
    ...
    function $_taskAdd( getParent ) {
        ...
        $('[data-btnfn="addTask"]').off('click').on('click', function(event) {
            ...
            $("[data-category='"+$_getParent+"'] .connect-sorting-section").append($html);
    ...
    $(".add-list").off('click').on('click', function(event) {
        ...
        $html = '<div data-category="s-'+$_listSectionDataAttr+'" class="task-list-container  mb-4 " data-connect="sorting">'+
                    '<div class="connect-sorting">'+
                        ...
                        '<div class="connect-sorting-section" data-sortable="true">'+
    ...
    function $_clearList() {
        $('.list-clear-all').off('click').on('click', function(event) {
            event.preventDefault();
            $(this).parents('[data-connect="sorting"]').find('.connect-sorting-section .card').remove();
        })
    }
